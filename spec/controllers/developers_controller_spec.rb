  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved developer as @developer" do
        ...
        post :create, {:developer => { "user_id" => "invalid value" }}, valid_session
        assigns(:developer).should be_a_new(Developer)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested developer" do
        ...
        Developer.any_instance.should_receive(:update_attributes).with({ "user_id" => "1" })
        put :update, {:id => developer.to_param, :developer => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the developer as @developer" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Developer.any_instance.stub(:save).and_return(false)
        put :update, {:id => developer.to_param, :developer => { "user_id" => "invalid value" }}, valid_session
        assigns(:developer).should eq(developer)
      end
